<hmtl>
    ...
    <head>
        ...
        <script src='<?php echo e(url("js/post_content.js")); ?>' defer></script>
        <script src='<?php echo e(url("js/post_show.js")); ?>' defer></script>
...
<div class='barra_sinistra'>
    <img src="<?php echo e(url('image/together.png')); ?>">
<h1>Together</h1>
...
<div id="user_case"><img class="img_case" src="<?php echo e(asset($user['image'])); ?>"></div>
<a href="<?php echo e(url ('logout')); ?>" id='logout'><h2> Logout </h2></a>
</div>
            </nav>
        </header>
        ...
        <div id="new_post">
                    <div id="img_profile" style="background-image:url(<?php echo e(asset($user['image'])); ?>)">  </div>
                    <div id="text">
                        <form action="<?php echo e(url('/new_post')); ?>" method="POST" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\hw2-app\resources\views/home.blade.php ENDPATH**/ ?>